...
\newcommand{\tycount}[2]{{#1}_{\,#2}}
\newcommand{\tycountp}[2]{\tycount{\typarens{#1}}{#2}}
...
\newcommand{\tyrec}[2]{\textbf{rec}\,#1.\,#2}
\newcommand{\tyvar}[1]{\textbf{tyvar}\,\,#1}
\newcommand{\tylst}[1]{\textbf{lst}\,#1}
\newcommand{\tynnlst}[1]{\textbf{lst}_{+}\,#1}
\newcommand{\typosnat}[0]{\textbf{nat}_{+}}
